...
import com.ryx.ryxcredit.newactivity.Utils.FaceCollectFailUtil;
import com.ryx.ryxcredit.newactivity.Utils.FaceCollectSucUtil;
 ...
 */
public class FaceCollectFragment extends Fragment {
    ...
    private void showSucWindow(Bundle result) {
        ...
        lay_fail.setVisibility(View.GONE);
        FaceCollectSucUtil.getInstance().initSucPage(getActivity(), result);
    }
    ...
    public void showFailWindow(Bundle result) {
        ...
        FaceCollectFailUtil.getInstance().initFailWindow(getActivity(), result);
    }
