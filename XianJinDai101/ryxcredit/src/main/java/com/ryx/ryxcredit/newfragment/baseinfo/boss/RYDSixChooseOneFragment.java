 ...
 */
public class RYDSixChooseOneFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.ryd_fragment_six_choose_one, container, false);
        initView();
        return rootView;
    }
    /*
 ...
 /*       ll_credit_card_certification= (AutoRelativeLayout) rootView.findViewById(R.id.xjd_ll_credit_card_certification);
    ...
    public void onClick(View v) {
        ...
        if (id == xjd_ll_quota_activation_credit) {
            //人行征信查询
