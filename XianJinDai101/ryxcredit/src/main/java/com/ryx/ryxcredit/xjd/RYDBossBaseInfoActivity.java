...
import com.ryx.ryxcredit.newfragment.baseinfo.boss.RYDBossPersonInfoFragment;
import com.ryx.ryxcredit.newfragment.baseinfo.boss.RYDBossWorkInfoFragment;
...
public class RYDBossBaseInfoActivity extends BaseActivity implements NewIBaseInfoFragmentCallback {
    ...
    Bundle args;
    public String getAuthorise_info_url() {
        return authorise_info_url;
    }

    public void setAuthorise_info_url(String authorise_info_url) {
        this.authorise_info_url = authorise_info_url;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("authorise_info_url")) {
            //瑞卡贷
            authorise_info_url = getIntent().getStringExtra("authorise_info_url");
        }
        setbottomMenu();
    ...
    private RYDBossPersonInfoFragment personfragment;
    ...
    private void changeFragmentPosition(BaseInfoEnum baseinfo) {
        ...
        if (baseinfo == BaseInfoEnum.WORK_INFO) {
            if (fragment == null)
                fragment = new RYDBossWorkInfoFragment();
           ...
           // setTitleLayout(getResources().getString(R.string.c_work_info), true, false);
            ...
            if (fragment == null) {
                personfragment = new RYDBossPersonInfoFragment();
   ...
   /*         if (fragment == null)
       ...
       /* //人行征信
        ...
        if (fragment != null) {
            ...
            args.putString("credit_type", credit_type);
...
* */
    ...
    private void addPersonMaterial(CSupplementaryMaterialsRequest req) {
        httpsPost(this, req, ReqAction.APPLICATION_CREATE_OR_MODIFY_CUSTOMER_BOSS, CSupplementaryMaterialsResponse.class, new ICallback<CSupplementaryMaterialsResponse>() {
            @Override
            public void success(CSupplementaryMaterialsResponse response) {
                ...
                customer.setCredit_code(cSupplementaryMaterialsRequest.getCredit_code());
                customer.setMonthly_turnover(cSupplementaryMaterialsRequest.getMonthly_turnover());
                customer.setLegal_partner(cSupplementaryMaterialsRequest.getLegal_partner());
   /*             //不需要采集电商信息
                if ("H".equals(user_info_level.trim())) {
                    changeFragmentPosition(BaseInfoEnum.FACERECOGNITION_INFO);
                }
            ...
            @Override
            public void failture(String tips) {
                CLogUtil.showToast(RYDBossBaseInfoActivity.this, tips);
                changeFragmentPosition(BaseInfoEnum.CALLRECORDS_INFO);
            }
        });
    }
