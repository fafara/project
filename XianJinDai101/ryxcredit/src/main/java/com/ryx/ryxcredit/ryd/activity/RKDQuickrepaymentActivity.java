...
public class RKDQuickrepaymentActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        xRecyclerView.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onRefresh() {
                if (HttpUtil.checkNet(RKDQuickrepaymentActivity.this)) {
                    requestBorrowRecord(productStrs[0]);
                } else {
                    CLogUtil.showToast(RKDQuickrepaymentActivity.this, "请检查网络！");
        ...
        borrowRecordsAdapter.setOnItemClickListener(new OnListItemClickListener<MultiBorrowRecordsResponse.ResultBean>() {
            ...
            public void onItemClick(View view, int position, MultiBorrowRecordsResponse.ResultBean data) {
                ...
                if ("A".equals(loanStatus)){
                    CLogUtil.showToast(RKDQuickrepaymentActivity.this,"已结清记录，不可还款！");
                    return;
                }
                if ("F".equals(loanStatus) || "G".equals(loanStatus) || "H".equals(loanStatus)){
                    CLogUtil.showToast(RKDQuickrepaymentActivity.this,"放款中，暂不可还款！");
                    return;
                }
                if (RyxcreditConfig.rkd_procudtid.equals(list.get(position).getProduct_id())) {
                    //判断是现金贷还是瑞卡贷
                    intent = new Intent(RKDQuickrepaymentActivity.this, RYDQuickrepaymentActivity.class);
                    intent.putExtra("flag","Repayment");
                } else {
                    intent = new Intent(RKDQuickrepaymentActivity.this, XJDRepaymentAcitivity.class);
                }
