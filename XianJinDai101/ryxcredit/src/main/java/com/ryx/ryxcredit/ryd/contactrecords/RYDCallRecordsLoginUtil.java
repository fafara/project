package com.ryx.ryxcredit.ryd.contactrecords;
...
public class RYDCallRecordsLoginUtil {
    ...
    private RYDCallRecordsFragment mfragment;
    private RYDBaseInfoSuccesActivity mainActivity;
    ...
    private View mView;
    public void onCreateView(RYDCallRecordsFragment fragment, View rootView) {
        mfragment = fragment;
        mView= rootView;
        mainActivity = (RYDBaseInfoSuccesActivity) mfragment.getActivity();
        initView();
    }
...
/*        contactInfo2 = (TextView) mView.findViewById(R.id.tv_contactinfo2);
        ...
        /*edt_accout.setText("18063442591");
        edt_pwd.setText("204723");*/
