...
import com.ryx.ryxcredit.ryd.utils.RYDFaceCollectFailUtil;
import com.ryx.ryxcredit.ryd.utils.RYDFaceCollectSucUtil;
 ...
 */
public class RYDFaceCollectFragment extends Fragment {
    private RYDBaseInfoSuccesActivity baseInfoActivity;
    ...
    private static RYDFaceCollectFragment instance;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        baseInfoActivity = (RYDBaseInfoSuccesActivity) getActivity();
         rootView = inflater.inflate(R.layout.c_new_base_facecollect_fragment, container, false);
    ...
    private void showSucWindow(Bundle result) {
        ...
        lay_fail.setVisibility(View.GONE);
        RYDFaceCollectSucUtil.getInstance().initSucPage(getActivity(), result);
    }
    ...
    public void showFailWindow(Bundle result) {
        ...
        RYDFaceCollectFailUtil.getInstance().initFailWindow(getActivity(), result);
    }
