package com.ryx.ryxcredit.newactivity.Utils;
...
public class FaceCollectFailUtil  {
    ...
    private void initView() {
        mAgainImg = (Button) ((BaseInfoSuccesActivity)mcontext).findViewById(R.id.btn_again);
        mRezionTv = (TextView) ((BaseInfoSuccesActivity)mcontext).findViewById(R.id.rezion_tv);
        mAgainImg.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mcontext, LiveDetectActivity.class);
                ((BaseInfoSuccesActivity)mcontext).startActivityForResult(intent,START_LIVEDETECT);
            }
        });
