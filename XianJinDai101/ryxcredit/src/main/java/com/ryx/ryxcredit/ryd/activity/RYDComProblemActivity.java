 ...
 */
public class RYDComProblemActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_ryd_com_problem_activity);
        setTitleLayout("瑞易贷常见问题", true, false);
        initView();
    }
    ...
    public void onClick(View v) {
        ...
        try {
            Intent intent = new Intent(RYDComProblemActivity.this, Class.forName(getApplicationContext().getPackageName()+".activity.HtmlMessageActivity_"));
...
//                intent.putExtra("ccurl", "file:///android_asset/www/f2/about.html");
                intent.putExtra("title", getResources().getString(R.string.tv_about_ryd));
