...
public class RYDFaceCollectFailUtil {
    private final String TAG = RYDFaceCollectFailUtil.class.getSimpleName();
    ...
    private static RYDFaceCollectFailUtil instance;

    public static RYDFaceCollectFailUtil getInstance() {
        if(instance==null){
            instance  = new RYDFaceCollectFailUtil();
        }
        return instance;
    }
    ...
    private void initView() {
        mAgainImg = (Button) ((RYDBaseInfoSuccesActivity)mcontext).findViewById(R.id.btn_again);
        mRezionTv = (TextView) ((RYDBaseInfoSuccesActivity)mcontext).findViewById(R.id.rezion_tv);
        mAgainImg.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mcontext, LiveDetectActivity.class);
                ((RYDBaseInfoSuccesActivity)mcontext).startActivityForResult(intent,START_LIVEDETECT);
            }
        });
