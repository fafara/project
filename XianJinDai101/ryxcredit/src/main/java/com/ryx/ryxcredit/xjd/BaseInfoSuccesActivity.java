...
import com.ryx.ryxcredit.newfragment.baseinfo.FundWebViewFragment;
...
import com.ryx.ryxcredit.newfragment.baseinfo.WebViewFragment;
...
public class BaseInfoSuccesActivity extends BaseActivity implements NewIBaseInfoFragmentCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setFragmentTitleLayout("工作信息", true, false);
       ...
       /* if (getIntent().hasExtra("credit_type")) {
            credit_type = getIntent().getStringExtra("credit_type");
        }*/
    ...
    private void initData() {
        ...
        httpsPost(this, request, ReqAction.APPLICATION_ACTIVATION_LIMIT, CActivateLineSearchResponse.class, new ICallback<CActivateLineSearchResponse>() {
            ...
            public void success(final CActivateLineSearchResponse cActivateLineResponse) {
                int cActivateLineCode = cActivateLineResponse.getCode();
                if (cActivateLineCode==5031) {
                    showMaintainDialog();
                } else {
   ...
   /*         if (fragment == null)
        ...
        //webview
            ...
            if (fragment == null)
                fragment = new FundWebViewFragment();
            credit_type = "social";
            if ("A".equals(user_info_level.trim()) ) {
                leadingDotsSuccessViews.change(2);
