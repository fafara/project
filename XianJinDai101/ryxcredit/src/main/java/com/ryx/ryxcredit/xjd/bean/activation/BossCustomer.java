package com.ryx.ryxcredit.xjd.bean.activation;

import java.io.Serializable;

/**
 * Created by RYX on 2017/8/3.
 */
...
public class BossCustomer implements Serializable{
    ...
    public Integer getMonthly_turnover() {
        return monthly_turnover;
    }

    public void setMonthly_turnover(Integer monthly_turnover) {
        this.monthly_turnover = monthly_turnover;
    }

    //月营业额
    private Integer monthly_turnover;
    //社会统一信用编码
    ...
    public String getJilianRequest() {
        return jilianRequest;
    }

    public void setJilianRequest(String jilianRequest) {
        this.jilianRequest = jilianRequest;
    }

    private String jilianRequest;
