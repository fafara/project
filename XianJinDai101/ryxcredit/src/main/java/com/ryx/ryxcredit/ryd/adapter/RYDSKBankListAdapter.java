...
/**
 * Created by TWH on 2017/8/24.
 */

public class RYDSKBankListAdapter extends HelperAdapter<CcardRepaymentResponse.ResultBean> {
     ...
     * @param layoutId 布局Id
     */
    public RYDSKBankListAdapter(List<CcardRepaymentResponse.ResultBean> data, Context context, int... layoutId) {
