package com.ryx.ryxcredit.newactivity.newFindCustommer;
...
public class CfindCustomerResponse {
    ...
    public static class ResultBean {
        public String getCard_activation() {
            return card_activation;
        }

        public void setCard_activation(String card_activation) {
            this.card_activation = card_activation;
        }

        public String getBusiness_activation() {
            return business_activation;
        }

        public void setBusiness_activation(String business_activation) {
            this.business_activation = business_activation;
        }
