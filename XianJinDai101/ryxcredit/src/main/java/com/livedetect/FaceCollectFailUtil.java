...
public class FaceCollectFailUtil  {
    ...
    private static FaceCollectFailUtil instance;

    public static FaceCollectFailUtil getInstance() {
        if(instance==null){
            instance  = new FaceCollectFailUtil();
        }
        return instance;
    }

    protected void initFailWindow(Context context,Bundle result) {
        mcontext = context;
    ...
    private void initView() {
        mAgainImg = (Button)((FaceCollectActivity)mcontext).findViewById(R.id.btn_again);
        mRezionTv = (TextView) ((FaceCollectActivity)mcontext).findViewById(R.id.rezion_tv);
        mAgainImg.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mcontext, LiveDetectActivity.class);
                ((FaceCollectActivity)mcontext).startActivityForResult(intent,START_LIVEDETECT);
            }
        });
