...
import com.ryx.payment.ruishua.authenticate.creditcard.CreditcardVertifyFailActivity_;
...
@EActivity(R.layout.activity_auth_result)
public class AuthResultActivity extends BaseActivity {
    ...
    @ViewById
    View line4,line9,line10,line11,line12;
    ...
    public void initViews() {
        ...
        isOpenMerchanttag = RyxAppdata.getInstance(AuthResultActivity.this).getIsOpenMerchantFlag();
        initDataView();
    ...
    public void initQtPatParams() {
        ...
        qtpayMobileNO.setValue(QtpayAppData.getInstance(AuthResultActivity.this)
                .getMobileNo());
    }
    ...
    protected void onResume() {
        super.onResume();
        if (QtpayAppData.getInstance(AuthResultActivity.this).isLogin()) {
            bankList.clear();
    ...
    private void analyzeCustomerInfo(String jsonStr) {
        ...
        try {
            ...
            QtpayAppData.getInstance(AuthResultActivity.this).setTagDesc(tagdesc);
    ...
    public void drawViewForServerData(){
        QtpayAppData.getInstance(AuthResultActivity.this).setAuthenFlag(
                authenFlag);
        QtpayAppData.getInstance(AuthResultActivity.this).setUserType(customerType);
...
//                "businesslicence": "ghjk"
    ...
    public void reAuth() {
        ...
        if("00".equals(customerType)&&authenFlag==3){
            ...
            startActivityForResult(new Intent(AuthResultActivity.this,
            ...
            LogUtil.showToast(AuthResultActivity.this,"用户状态有误,请重新获取!");
        }
    }
    ...
    public void seniorAuth() {
        ...
        if ("0".equals(powermsg)) {
            isneedreq = false;
            Intent intent = new Intent(AuthResultActivity.this,
    ...
    public void clickbankItem(int pos) {
        if ("2".equals(bankList.get(pos).get("status"))
            ...
            isNeedThread = false;
            startActivityForResult(new Intent(AuthResultActivity.this,
                    CreditcardVertifyFailActivity_.class).putExtra("BankCardInfo",
        ...
        try {
            ...
            for (int i = 0; i < len; i++) {
                ...
                map.put("name", QtpayAppData.getInstance(
                        AuthResultActivity.this).getRealName());
