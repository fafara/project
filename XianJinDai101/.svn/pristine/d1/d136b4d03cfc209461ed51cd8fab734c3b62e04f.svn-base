...
public class MultiBorrowRecordDetailReponse extends CbaseResponse implements Serializable{

    /**
     * result : {"loan_amount":1000,"service_agreement_url":"https://mposprepo.ruiyinxin.com:4430/xiaodai/ruikadai_service_agreement.html","loan_date":"20171203","schedule_curr_bal":1020.41,"remain_total_amount":920.3,"term_repay_amount":1020.41,"interest_amount":0,"term_spans":7,"overdue_interest":0,"sub_cost_rate":0.004,"sub_overdue_interest_rate":0.5,"other_cost_rate":0.016,"money_manage_url":"https://mposprepo.ruiyinxin.com:4430/xiaodai/credit_consult_and_manager.html","sub_cost_amount":4.08,"total_term_svcfee":0,"repayment_card_num":"6217002020019621788","other_overdue_interest_amount":0,"overdue_interest_rate":1.8,"paid_cash_card":"支持银行：网银银行,建设银行,招商银行,农业银行,中信实业银行,恒丰银行,广东发展银行,深圳发展银行,光大银行,兴业银行,交通银行,名生银行,华夏银行,上海浦发发展银行","term_fixed_repay_amount":1020.41,"expired_date":"20171209","interest_rate":0.004,"other_cost_amount":16.33,"total_amount":1020.41,"owed_amount":920.3,"other_overdue_interest_rate":4.5,"business_date":"20171204","sub_overdue_interest_amount":0,"loan_status":"D","repayments":[{"loan_status":"S","repayment_amount":100.11,"repayment_datetime":"20171016120013"}],"status":1,"payment_title_code":"105","repaid_amount":100.11,"repaid_cash_card":"支持银行：工商银行,农业银行,中国银行,建设银行,交通银行,兴业银行,中信银行,光大银行,浦发银行,平安银行,广发银行,华夏银行,邮储银行,民生银行,恒丰银行","contract_id":"800717120300002483","term_date":"20171209","repayment_bank_url":"https://mposprepo.ruiyinxin.com:4430/xiaodai/bank_list.html","overdue_days":0,"payment_card_num":"6217002020019621788","cost_amount":20.41,"repayment_bank_code":"01050000","repayment_title_code":"105","payment_bank_code":"01050000","contract_url":"https://mposprepo.ruiyinxin.com:4430/xiaodai/loanContractTem.html","overdue_interest_amount":0,"customer_id":"100020","loan_datetime":"20171203","span_unit":"D"}
     * code : 2000
     */
    ...
    public static class ResultBean implements Serializable{
        /**
         * loan_amount : 1000
         * service_agreement_url : https://mposprepo.ruiyinxin.com:4430/xiaodai/ruikadai_service_agreement.html
         * loan_date : 20171203
         * schedule_curr_bal : 1020.41
         * remain_total_amount : 920.3
         * term_repay_amount : 1020.41
         * interest_amount : 0
         * term_spans : 7
         * overdue_interest : 0
         * sub_cost_rate : 0.004
         * sub_overdue_interest_rate : 0.5
         * other_cost_rate : 0.016
         * money_manage_url : https://mposprepo.ruiyinxin.com:4430/xiaodai/credit_consult_and_manager.html
         * sub_cost_amount : 4.08
         * total_term_svcfee : 0
         * repayment_card_num : 6217002020019621788
         ...
         * term_fixed_repay_amount : 1020.41
         * expired_date : 20171209
         * interest_rate : 0.004
         * other_cost_amount : 16.33
         * total_amount : 1020.41
         * owed_amount : 920.3
         * other_overdue_interest_rate : 4.5
         * business_date : 20171204
         * sub_overdue_interest_amount : 0
         * loan_status : D
         * repayments : [{"loan_status":"S","repayment_amount":100.11,"repayment_datetime":"20171016120013"}]
         * status : 1
         * payment_title_code : 105
         * repaid_amount : 100.11
         * repaid_cash_card : 支持银行：工商银行,农业银行,中国银行,建设银行,交通银行,兴业银行,中信银行,光大银行,浦发银行,平安银行,广发银行,华夏银行,邮储银行,民生银行,恒丰银行
         * contract_id : 800717120300002483
         * term_date : 20171209
         * repayment_bank_url : https://mposprepo.ruiyinxin.com:4430/xiaodai/bank_list.html
         * overdue_days : 0
         * payment_card_num : 6217002020019621788
         * cost_amount : 20.41
         * repayment_bank_code : 01050000
         * repayment_title_code : 105
         * payment_bank_code : 01050000
         * contract_url : https://mposprepo.ruiyinxin.com:4430/xiaodai/loanContractTem.html
         * overdue_interest_amount : 0
         * customer_id : 100020
         * loan_datetime : 20171203
         * span_unit : D
         */
        ...
        private double other_overdue_interest_amount;
        ...
        private double sub_overdue_interest_amount;
        ...
        public String getTerm_spans() {
            return term_spans;
        }

        public void setTerm_spans(String term_spans) {
        ...
        public double getOther_overdue_interest_amount() {
            return other_overdue_interest_amount;
        }

        public void setOther_overdue_interest_amount(double other_overdue_interest_amount) {
        ...
        public void setOther_cost_amount(String other_cost_amount) {
        ...
        public double getSub_overdue_interest_amount() {
            return sub_overdue_interest_amount;
        }

        public void setSub_overdue_interest_amount(double sub_overdue_interest_amount) {
        ...
        public static class RepaymentsBean implements Serializable{
            /**
             * loan_status : S
             * repayment_amount : 100.11
             * repayment_datetime : 20171016120013
             */
