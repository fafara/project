package com.ryx.ryxgesturespswd.widget;
...
import com.ryx.ryxgesturespswd.R;
...
public class LockPatternView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		Log.e("ryx", "(width: " + width + "  ,  height" + height + ")");
		if (width != height) {
	...
	private void initPaints(){
		...
		defaultPaint.setColor(getResources().getColor(R.color.grey_999999));
		defaultPaint.setStrokeWidth(2.0f);
		defaultPaint.setStyle(Style.STROKE);
		defaultPaint.setAntiAlias(true);
		
		selectPaint = new Paint();
		selectPaint.setColor(getResources().getColor(R.color.blue_1db7f0));
