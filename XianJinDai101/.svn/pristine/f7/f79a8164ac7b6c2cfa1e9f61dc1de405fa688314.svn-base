...
/**
 * Created by xucc on 2016/8/2.
 */
//扫码支付
@EFragment(R.layout.fragment_sweepcode)
public class SweepCodeFragment extends BaseFragment {
    ...
    public static SweepCodeFragment newInstance() {
        SweepCodeFragment fragment = new SweepCodeFragment_();
        return fragment;
    }
    ...
    private void initViews(){
        ...
        lv_payment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("ActivityFlag", "sweepcode");
