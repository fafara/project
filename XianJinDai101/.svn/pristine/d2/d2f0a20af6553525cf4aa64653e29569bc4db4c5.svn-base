package com.ryx.payment.ryxhttp;

import android.os.Handler;
import android.os.Looper;

import com.ryx.payment.ryxhttp.builder.GetBuilder;
import com.ryx.payment.ryxhttp.builder.HeadBuilder;
import com.ryx.payment.ryxhttp.builder.OtherRequestBuilder;
import com.ryx.payment.ryxhttp.builder.PostFileBuilder;
import com.ryx.payment.ryxhttp.builder.PostFormBuilder;
import com.ryx.payment.ryxhttp.builder.PostStringBuilder;
import com.ryx.payment.ryxhttp.callback.Callback;
import com.ryx.payment.ryxhttp.cookie.CookieJarImpl;
import com.ryx.payment.ryxhttp.cookie.store.CookieStore;
import com.ryx.payment.ryxhttp.cookie.store.HasCookieStore;
import com.ryx.payment.ryxhttp.cookie.store.MemoryCookieStore;
import com.ryx.payment.ryxhttp.https.HttpsUtils;
import com.ryx.payment.ryxhttp.log.LoggerInterceptor;
...
public class OkHttpUtils
{
    ...
    private static final String VERIFY_HOST="mposprepo.ruiyinxin.com";
    private static final String VERIFY_HOST1="mpostest.ruiyinxin.com";
    ...
    public OkHttpUtils(OkHttpClient okHttpClient)
    {
        if (okHttpClient == null)
        {
            ...
            okHttpClientBuilder.hostnameVerifier(new HostnameVerifier()
            {
                ...
                {
                    if (hostname.equals(VERIFY_HOST)||hostname.equals(VERIFY_HOST1))
                        return true;
                    else
                        return false;
                }
...
//        return new PostStringBuilder();
        return  new PostStringBuilder().mediaType(MediaType.parse("application/x-www-form-urlencoded;charset=UTF-8"));
    }
