...
public class IncomeDetailInfoAdapter extends HelperAdapter<Map> {
     ...
     * @param layoutId 布局Id
     */
    public IncomeDetailInfoAdapter(List<Map> data, Context context, int... layoutId) {
    ...
    protected void HelperBindData(final HelperViewHolder viewHolder, final int position, final Map item) {
        ...
        if (null != item) {
            ...
            String paymsgStr=    MapUtil.get(item,"dt_name","");
            String localdateStr=    MapUtil.get(item,"deal_date","");
            String pay_incomeStr=    MapUtil.get(item,"money","");
