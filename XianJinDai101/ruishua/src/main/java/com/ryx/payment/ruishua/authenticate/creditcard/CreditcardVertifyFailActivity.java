...
public class CreditcardVertifyFailActivity extends BaseActivity {
    ...
    public void reauth() {
        startActivityForResult(new Intent(CreditcardVertifyFailActivity.this,
                CreditCardAuthStep1Activity_.class).putExtra("BankcardId",
