...
import com.ryx.payment.ruishua.convenience.PaymentSuccessful;
 ...
 * 刷卡支付查余额Swiper页面
 */
@EActivity(R.layout.ryxpayplug_swiper)
public class RyxPaySwiperActivity extends PayPlugBaseActivity implements BlueToothListener, CardTipPwdListener {
    /**
     * 跳转资料补充页Flag
     */
    ...
    public void initView(){
        ...
        Glide.with(RyxPaySwiperActivity.this).load(R.drawable.img_shoukuan_shuaka).into(shuaka);
    }
    /**
     * 初始化设备资源
     */
    private void initDev() {
        ...
        initQtPatParams();
        dialog= new SimpleDialog(RyxPaySwiperActivity.this);
        dialog.setContentView(R.layout.dialog_swipe_card);
        dialog.setCanceledOnTouchOutside(false);
        dialog_ic= new SimpleDialog(RyxPaySwiperActivity.this);
        dialog_ic.setContentView(R.layout.dialog_swipe_card_ic);

        myDialog = new SimpleDialog(RyxPaySwiperActivity.this);
        myDialog.setContentView(R.layout.dialog_swipe_card_ic);


        messagedialog=  new RyxLoadDialog().getInstance(RyxPaySwiperActivity.this);
        messagedialog.setCanceledOnTouchOutside(false);
        messagedialog.setCancelable(false);
        bluelistdialog = new BluetoothDialog(RyxPaySwiperActivity.this,deviceinfo,RyxPaySwiperActivity.this);
        bluelistdialog.setCanceledOnTouchOutside(false);

        inputDialog = new CardpwdInputDialog(RyxPaySwiperActivity.this, com.ryx.ryxkeylib.R.style.mydialog,this,true);
        inputDialog.setCanceledOnTouchOutside(false);
        dialog_download = new ICDownloadDialog(RyxPaySwiperActivity.this);
            ...
            requesDevicePermission(waring, 0x0012, new PermissionResult() {
                        ...
                        public void requestSuccess() {
                            ...
                            if (RyxSwiperCode.devsNames.length == 1) {
                                ...
                                AudioTypesDialog audioTypesDialog = new AudioTypesDialog(RyxPaySwiperActivity.this, new AudioTypesDialog.AudioTypeItemSlectListener() {
                                    @Override
                        ...
                        public void requestFailed() {
                            LogUtil.showToast(RyxPaySwiperActivity.this, finalWaring);
...
//        }
    ...
    private void initBlu() {
        ...
        if(blueToothSearchCommonAdapter==null){
            blueToothSearchCommonAdapter = new BlueToothSearchCommonAdapter(
                    RyxPaySwiperActivity.this, toothSearchListener, 15 * 1000);
        }
    ...
    private void initAudioDevs() {
        ...
        messagedialog.show();
        ryxSwiper = new RyxSwiper(RyxPaySwiperActivity.this, type, ryxSwiperListener);
        rundetect();
    }
    /**
     * 新的设备检测方法
    ...
    public void initQtPatParams() {
        ...
        //获取上次连接的蓝牙设备mac
        myshareblueDeviceMac= PreferenceUtil.getInstance(RyxPaySwiperActivity.this).getString("myblueDeviceMac", "");
    }
        ...
        if (resultCode == RyxAppconfig.QT_RESULT_OK) {
            ...
            if (requestCode == PAYWITHSIGN) {
                ...
                if ("Finish".equals(result)) {
                    exitswiper(new RyxPaySwiperActivity.Exitswiperlisten() {
                        @Override
    ...
    private void exitswiper(final RyxPaySwiperActivity.Exitswiperlisten exitswiperlisten) {
        isfinishing=true;
            ...
            switch (msg.what) {
                ...
                case RyxSwiperCode.ACTION_BLUETOOTH_CONNECT_SUCCESS:
                    ...
                    if(!"".equals(currentConnectblueDeviceMac)&&!currentConnectblueDeviceMac.equals(myshareblueDeviceMac)){
                        PreferenceUtil.getInstance(RyxPaySwiperActivity.this).saveString("myblueDeviceMac", currentConnectblueDeviceMac);
                    }
...
//                    initdialog.show();
                ...
                case RyxSwiperCode.ACTION_SWIPE_IC_READING:
                    com.ryx.payment.ruishua.utils.LogUtil.showToast(RyxPaySwiperActivity.this, "IC卡读取中，等待界面跳转，交易完成前请勿拔卡", "up");
                    break;
                case RyxSwiperCode.ACTION_SWIPE_IC_WRITEBACK:
                    ...
                    messagedialog.dismiss();
//				if(writresult!=1){
//					LOG.showToast(RyxPaySwiperActivity.this, "IC回写失败!!!");
//				}
                    if (qtpayApplication.getValue().equals("BankCardBalance.Req")) {
                        intentBalance();
                            ...
                            ||qtpayApplication.getValue().equals("TradeMerchant.Req")) {
                        intentCardPay();
                    }
                    break;
                ...
                case RyxSwiperCode.ACTION_DOWNLOADRESULT_FAIL:
                    ...
                    com.ryx.payment.ruishua.utils.LogUtil.showToast(RyxPaySwiperActivity.this, "注入IC参数失败,请稍后再试!");
                    break;
                case RyxSwiperCode.ACION_SWIPER_COMMON_ERROR:
//                    messagedialog.dismiss();
                    if (null != msg.obj) {
                        com.ryx.payment.ruishua.utils.LogUtil.showToast(RyxPaySwiperActivity.this, msg.obj.toString());
                    }
                    break;
                case RyxSwiperCode.ACTION_DOWNLOADRESULT_SUCCESS://公钥单个注入成功
                    ...
                    if (pos == publickeyInfolist.size() + list.size()) {
                        dialog_download.setTip(pos,
                                publickeyInfolist.size() + list.size());
                        dialog_download.dismiss();
                        LogUtil.showToast(RyxPaySwiperActivity.this,"数据同步成功");
                        updatePsam();
                    }
                    break;
...
//                            LogUtil.showToast(RyxPaySwiperActivity.this,"请使用带密码键盘设备进行交易!");
                            RyxSimpleConfirmDialog ryxSimpleConfirmDialog = new RyxSimpleConfirmDialog(RyxPaySwiperActivity.this, new ConFirmDialogListener() {
                ...
                case RyxSwiperCode.ACTION_GETKSN_FAIL:
                    messagedialog.dismiss();
                    LogUtil.showToast(RyxPaySwiperActivity.this,"获取设备信息失败!");

                    break;
                case RyxSwiperCode.ACTION_SWIPER_CANCEL:
                    LogUtil.showToast(RyxPaySwiperActivity.this,"交易取消!");
                    dialog_ic.dismiss();
                    exitswiper(new RyxPaySwiperActivity.Exitswiperlisten() {
                        @Override
                        public void exitswipersuccess() {
                ...
                case RyxSwiperCode.ACTION_SWIPER_FAIL:
                    if(!isfinishing){
                        LogUtil.showToast(RyxPaySwiperActivity.this,"连接设备失败!");
                        messagedialog.dismiss();
                        dialog_ic.dismiss();
                    }
                    break;
                case RyxSwiperCode.ACTION_SWIPER_TIMEOUT:
                    LogUtil.showToast(RyxPaySwiperActivity.this,"操作超时!");
                    dialog_ic.dismiss();
                    break;
                ...
                case RyxSwiperCode.ACION_SWIPER_DEMOTIONTRADE:
                    if (null != msg.obj) {
                        LogUtil.showToast(RyxPaySwiperActivity.this,msg.obj.toString());
                    }
...
//        }
        ...
        }else if("13".equals(orderinfo.getInterfaceTag())){
            qtpayApplication = new Param("application", "TradeMerchant.Req");
            qtpayParameterList.add(new Param("industId",orderinfo.getIndustId()));
            qtpayParameterList.add(new Param("industUserId",orderinfo.getIndustUserId()));
        }else {
            qtpayApplication = new Param("application", "JFPalCardPay.Req");
            qtpayParameterList.add(new Param("tradecode",orderinfo.getTradecode()));
        }
        ...
        qtpayProvinceId = new Param("bankProvinceId", baseprovinceid);
//        String cardTagss = RyxAppdata.getInstance(RyxPaySwiperActivity.this)
//                .getRuishuaParam(
//                        RyxAppdata.getInstance(RyxPaySwiperActivity.this).getMobileNo(),
//                        "cardNo", "");
        String cardIdxss=orderinfo.getCardIdx();
//        String cardIdxss = RyxAppdata.getInstance(RyxPaySwiperActivity.this)
//                .getRuishuaParam(
//                        RyxAppdata.getInstance(RyxPaySwiperActivity.this).getMobileNo(),
//                        "cardIdx", "");
        //cardTag无意义去除
...
//            cardTag = new Param("cardTag", cardTagss);
        ...
        httpsPost("JFPalCardPayTag", new XmlCallback() {
            @Override
            public void onTradeSuccess(RyxPayResult payResult) {
                com.ryx.payment.ruishua.utils.LogUtil.showToast(RyxPaySwiperActivity.this, payResult.getRespDesc());
                if ("11".equals(cardtype)) {
                    showunplugin = "show";
                    messagedialog.setMessage("ic回写中，请稍后...");
                    messagedialog.show();
...
//      新屏蔽  doRequest(new onRequestSuccessListener() {
//
//            @Override
...
//        });
    ...
    private void intentCardPay() {
        if (orderinfo.isNeedSign()) {

            getSignSlip();

        } else {
            Intent intent = new Intent(RyxPaySwiperActivity.this, PaymentSuccessful.class);
    ...
    public void intentactivity() {
        ...
        Intent intent = new Intent(RyxPaySwiperActivity.this, SignRequisitions_.class);
        intent.putExtra("showunplugin", showunplugin);
    ...
    private void intentBalance() {
        Intent itbalance = new Intent(RyxPaySwiperActivity.this, CardBalanceResultActivity_.class);
    ...
    public void ordinarySwiper(){
        if ((!"balance".equals(actiontype)) && orderinfo.isNeedSign()) {
            if("12".equals(orderinfo.getInterfaceTag())||"13".equals(orderinfo.getInterfaceTag())){
                //小贷还款或者是收款台
                Intent it = new Intent(RyxPaySwiperActivity.this, OrderSignature_.class);
...
//                        if(RyxAppconfig.QTNET_SUCCESS.equals(resultCode)){
                            ...
                            if("0".equals(status)){
                                ...
                                LogUtil.showToast(RyxPaySwiperActivity.this,msg+"");
                            }
//                        }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            LogUtil.showToast(RyxPaySwiperActivity.this,"费率信息异常,请联系代理重新设置!");
                        }
                    }
                });
            }
                    ...
                    try{
                        ...
                        if(RyxAppconfig.QTNET_SUCCESS.equals(code)){
                            ...
                            if("1".equals(uploadflag)||"2".equals(uploadflag)||"3".equals(uploadflag)){
                                Intent swiperMsgIntent=new Intent(RyxPaySwiperActivity.this,SwiperMsgUploadActivity_.class);
                                //因资料上传界面拍照耗内存
                        ...
                        LogUtil.showToast(RyxPaySwiperActivity.this,"StripeCardJude数据异常,请稍后再试!");
                    }
                }
            });
        }else{
...
//        Toast.makeText(this,"交易进行中,请稍后",Toast.LENGTH_SHORT).show();
...
//                @Override
//                public void run() {
//                    Intent intent=new Intent(RyxPaySwiperActivity.this,PaySuccessActivity.class);
