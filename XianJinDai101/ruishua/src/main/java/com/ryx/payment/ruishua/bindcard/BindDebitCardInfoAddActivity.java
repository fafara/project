...
public class BindDebitCardInfoAddActivity extends BaseActivity {
    ...
    public void searchBankCity() {
        if (isProvinceSelected == true) {
            ...
            LogUtil.showToast(BindDebitCardInfoAddActivity.this, getResources().getString(R.string.please_select_province_bank));
        }
    }
    ...
    private void initBranchList() {
        if (!"0".equals(islast)) {
            LogUtil.showToast(BindDebitCardInfoAddActivity.this, "无记录！");
            if (isRefresh) {
        ...
        try {
            if (!islast.equals("1")) {    // 如果不是最后一页，才可以进一步加载更多
                ...
                if (RyxAppconfig.QTNET_SUCCESS.equals(jsonObj.getJSONObject("result").getString("resultCode"))) {
                    ...
                    LogUtil.showToast(BindDebitCardInfoAddActivity.this, toastmsg);
                }
            }
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    public boolean isParamsOK() {
        ...
        if (!isBankselected || bankId.length() == 0) {
            LogUtil.showToast(BindDebitCardInfoAddActivity.this, getResources().getString(R.string.please_select_head_bank));
            return false;
        }
        ...
        if (!isCitySelected && bankCityId.length() == 0) {
            LogUtil.showToast(BindDebitCardInfoAddActivity.this, getResources().getString(R.string.please_select_bank_city));
            return false;
        }
        return true;
    }
    ...
    public void bindCard(){
        if (isParamsOK()) {
            if(isBranchSelected){
                ...
                LogUtil.showToast(BindDebitCardInfoAddActivity.this, getResources().getString(R.string.select_the_account_where_the_branch));
            }
        }
    }
    ...
    private void showDialog() {
        ...
        final com.rey.material.app.Dialog dialog = builder.build(BindDebitCardInfoAddActivity.this);
    ...
    private void showBranchDialog() {
        ...
        com.rey.material.app.Dialog.Builder builder =
                new com.rey.material.app.Dialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog);
        branchDialog = builder.build(BindDebitCardInfoAddActivity.this);
