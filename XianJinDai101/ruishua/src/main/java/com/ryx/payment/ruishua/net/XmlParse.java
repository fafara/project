package com.ryx.payment.ruishua.net;
...
import static com.ryx.payment.ruishua.RyxAppconfig.API_SIGN_KEY;
...
public class XmlParse {
    ...
    public static String creatRequest(ArrayList<Param> list1, ArrayList<Param> list2) {
        ...
        LogUtil.showLog("creatRequest---requestXML="+requestXML+"----API_SIGN_KEY="+RyxAppconfig.API_SIGN_KEY+",newsign="+newsign);
        return "requestXml=" + requestXML.replace(API_SIGN_KEY, newsign);
    }
    ...
    public static String creatRequestWithPic(ArrayList<Param> list1, ArrayList<Param> list2) {
        ...
        LogUtil.showLog("creatRequestWithPicAPI_SIGN_KEY="+ API_SIGN_KEY+",newsign="+newsign);
        return "requestXml=" + requestXML.replace(API_SIGN_KEY, newsign);
    }
