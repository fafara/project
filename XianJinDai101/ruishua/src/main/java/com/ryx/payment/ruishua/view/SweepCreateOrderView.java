...
public class SweepCreateOrderView extends LinearLayout implements OnClickListener {
	private Button bt;
	 ...
	 */
	public SweepCreateOrderView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);// 通过SystemService获得layout扩展服务
		inflater.inflate(R.layout.sweep_creatorder, this);// 实例化xml布局文件
