 ...
 * 微信二维码
 */
@EActivity(R.layout.activity_wei_xin_qrcode_pay)
public class WeiXinQrcodePayActivity extends PayPlugBaseActivity {
    @ViewById
    ...
    public void initView(){
        setTitleLayout(RyxAppdata.getInstance(this).getCurrentBranchName()+"微信收款台",true);
