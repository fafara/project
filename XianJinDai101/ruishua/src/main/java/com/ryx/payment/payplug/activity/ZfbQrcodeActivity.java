 ...
 * 支付宝二维码支付
 */
@EActivity(R.layout.activity_zfb_qrcode)
public class ZfbQrcodeActivity extends PayPlugBaseActivity {
    @ViewById
    ...
    public void initView(){
        setTitleLayout(RyxAppdata.getInstance(this).getCurrentBranchName()+"支付宝收款台",true);
